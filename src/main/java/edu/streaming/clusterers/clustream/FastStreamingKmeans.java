package edu.streaming.clusterers.clustream;
...
import edu.streaming.clusterers.util.faststreamingkm.Assignment;
import edu.streaming.clusterers.util.faststreamingkm.Assignments;
import edu.streaming.clusterers.util.faststreamingkm.CandidateCluster;
import edu.streaming.clusterers.util.faststreamingkm.DenseVector;
import edu.streaming.clusterers.util.faststreamingkm.DoubleVector;
import edu.streaming.clusterers.util.faststreamingkm.GeneralizedOrssSeed;
import edu.streaming.clusterers.util.faststreamingkm.HardAssignment;
import edu.streaming.clusterers.util.faststreamingkm.IntIterator;
import edu.streaming.clusterers.util.faststreamingkm.IntegerVector;
import edu.streaming.clusterers.util.faststreamingkm.Matrices;
import edu.streaming.clusterers.util.faststreamingkm.Matrix;
import edu.streaming.clusterers.util.faststreamingkm.ReflectionUtil;
import edu.streaming.clusterers.util.faststreamingkm.SimilarityFunction;
import edu.streaming.clusterers.util.faststreamingkm.Vector;
import edu.streaming.clusterers.util.faststreamingkm.VectorMath;
import edu.streaming.clusterers.util.faststreamingkm.Vectors;
            ...
            // algorithm), reduce the kappa clusters into k clusters.
                ...
                if (facilities.size() <= numClusters) {
                    ...
                    for (int j = 0; j < numFacilities; ++j) {
                        ...
                        verbose(LOGGER, "Facility %d had a center of mass at %s",
                                    j, 0/*fac.centerOfMass()*/);
...
//                                                    fac.centerOfMass());
                            ...
                            if (curAssignment != mostSim) { 
                                verbose(LOGGER, "Facility %d changed its " +
                                            "centroid from %d to %d",
                                            i,0/* curAssignment, mostSim*/);
                                numChanged++;
                            }
                            i++;
                        }
                        ...
                        verbose(LOGGER, "%d centroids swapped their facility",
                                    numChanged,0);
                    } while (numChanged > 0 && 
    ...
    private void verbose(Logger logger2, String string, int size, int size2) {
