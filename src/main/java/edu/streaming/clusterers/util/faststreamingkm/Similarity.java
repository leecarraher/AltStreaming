...
import edu.streaming.ucla.sspace.similarity.AverageCommonFeatureRank;
import edu.streaming.ucla.sspace.similarity.CosineSimilarity;
import edu.streaming.ucla.sspace.similarity.EuclideanSimilarity;
import edu.streaming.ucla.sspace.similarity.JaccardIndex;
import edu.streaming.ucla.sspace.similarity.KLDivergence;
import edu.streaming.ucla.sspace.similarity.KendallsTau;
import edu.streaming.ucla.sspace.similarity.LinSimilarity;
import edu.streaming.ucla.sspace.similarity.PearsonCorrelation;
import edu.streaming.ucla.sspace.similarity.SimilarityFunction;
import edu.streaming.ucla.sspace.similarity.SpearmanRankCorrelation;
import edu.streaming.ucla.sspace.similarity.TanimotoCoefficient;
import edu.streaming.ucla.sspace.util.DoubleEntry;
import edu.streaming.ucla.sspace.util.IntegerEntry;
import edu.streaming.ucla.sspace.vector.CompactSparseIntegerVector;
import edu.streaming.ucla.sspace.vector.DenseVector;
import edu.streaming.ucla.sspace.vector.DoubleVector;
import edu.streaming.ucla.sspace.vector.IntegerVector;
import edu.streaming.ucla.sspace.vector.SparseIntegerVector;
import edu.streaming.ucla.sspace.vector.SparseVector;
import edu.streaming.ucla.sspace.vector.Vector;
